  ...
  return (
    <main className="min-h-screen px-4 py-8 text-slate-900 transition dark:text-slate-100 md:px-6">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="flex flex-col items-start rounded-[28px] border border-[#d2d2d7] bg-white/95 p-8 shadow-[0_10px_34px_rgba(0,0,0,0.07)] dark:border-[#424245] dark:bg-[#1d1d1f] dark:shadow-[0_24px_58px_rgba(0,0,0,0.42)]">
          <div>
